...
<head>
    ...
    <title>Criar Nova Conta — Cursos GT</title>
...
<body class="antialiased min-h-screen flex items-center justify-center bg-radial-glow h-screen select-none">
    ...
    <main class="w-full max-w-[440px] p-6 z-10 m-auto">
        ...
        <div class="glass-card rounded-xl p-10">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-text-muted mt-1 text-xs font-semibold uppercase tracking-wider">Crie sua conta para iniciar os estudos</p>
            </div>
            ...
            <form id="registerForm" class="space-y-4">
                ...
                <div class="input-group">
                    ...
                    <input autocomplete="name" class="custom-input" id="name" name="name" placeholder="Seu nome" required type="text">
                </div>
                ...
                <div class="input-group">
                    ...
                    <div class="relative">
                        <input class="custom-input pr-12" id="password" name="password" placeholder="Mínimo 6 caracteres" required type="password">
                ...
                <div class="hidden text-error text-xs font-semibold mt-2" id="error-message">
                    <span class="flex items-center gap-2">
                        ...
                        <span id="error-text">Ocorreu um erro no cadastro.</span>
                    </span>
                </div>
                
                <!-- Submit Button -->
                <button class="w-full btn-primary font-bold py-4 rounded-lg uppercase tracking-[0.15em] text-[12px] mt-4 flex items-center justify-center gap-2" type="submit" id="submitBtn">
    ...
    <script>
        ...
        document.getElementById('registerForm').addEventListener('submit', function(e) {
            ...
            btnText.textContent = 'Processando Cadastro...';
